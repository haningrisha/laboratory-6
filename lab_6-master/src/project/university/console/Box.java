...
public class Box implements Serializable {
    ...
    private String removeAll() {
        HashSet<Show> set = new HashSet();
        setCollection(set, false);
        save(false);
        return "Команда выполнена";
    }
    ...
    private String add(String[] separate, boolean message) {
        try {
            ...
            add(name, rating, theme, message, author);
            return "Команда выполнена";
            ...
            return "Непрфвильный формат ввода";
        }
    }
        ...
        for (int i = 0; i < strings.length; i++) {
            ...
            switch (line[0].split("\"")[1].trim()) {
                ...
                case "theme":
                    ...
                    break;
                case "author":
                    hashMap.put("author", line[1].trim());
                    break;
                default:
     ...
     * @param message если true- вывод сообщение об удачном выполнении команды, если false- нет
     */
    synchronized private void add(String name, int rating, Interests theme, boolean message) {

        Show show = new Show(name, rating, theme);
        add(show, message);

    }
    synchronized private void add(String name, int rating, Interests theme, boolean message, Author author) {
     ...
     * @param massege если true- вывод сообщение об удачном выполнении команды, если false- нет
     */
    public String save(Boolean massege) {
        File file = new File("collection.xml");
     ...
     */
    private String remove(Show object) {
